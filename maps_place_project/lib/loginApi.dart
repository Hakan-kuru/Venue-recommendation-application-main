...
class _SignUpFormState extends State<SignUpForm> with WidgetsBindingObserver {
      ...
      if (_formKey.currentState!.validate() &&
        ...
        Future.delayed(Duration(seconds: 2), () {
          ...
          if (passwordController.text.isNotEmpty && epostaKonrtol == false) {
            ...
            debugPrint("${epostaKonrtol.toString()}");
            confetti.fire();
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  decoration: InputDecoration(
                    filled: true,
                    fillColor: backgroundColorLight, //Color(0xFFF0F4F8),
                    prefixIcon: Padding(
  ...
  Future<void> sendEmail() async {
    try {
      String username =
          'Hakan.k3272@gmail.com'; // Gmail e-posta adresiniz
      String password = 'erqg smzw yyfo urxe'; // Gmail şifreniz
