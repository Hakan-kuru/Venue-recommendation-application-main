  ...
  Widget build(BuildContext context) {
    ...
    return ScreenUtilInit(
      ...
      builder: (context, child) => WillPopScope(
        ...
        child: Scaffold(
          backgroundColor: Color(0xFFF0F4F8), //backgroundColorLight,
          bottomNavigationBar: CurvedNavigationBar(
            height: 55,
            color: secondaryColor, //color: Color(0xFFFF6B6B),
            backgroundColor: backgroundColorLight, //Color(0xFFF0F4F8),
                ...
                return Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: backgroundColorLight, //const Color(0xFFF0F4F8),
                    ),
                    child: ListTile(
                      title: Column(
